...
fortunes = [
    ...
    "People are attracted by your features.",
    ...
    "Your adventures could lead to happiness.",
...
def fortune():
    fortune_cookie = random.choice(fortunes)
    print(f'Your fortune cookie says: {fortune_cookie}')
    print('Would you like to get another fortune cookie?')
    print('1. Yes')
    print('2. No')
    fortunequestion = int(input('What would you like to do? 1. yes, 2. no: '))
    if fortunequestion == 1:
        fortune()
    elif fortunequestion == 2:
